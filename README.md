...
1. Write the bash command that clones your repository for this worksheet into the current working directory. 

1. Write a bash command to change your current working directory into the repository cloned in the question above. 

1. Write a bash command that opens the file `README.md` in the text editor of your choice. 
